package ru.chalovai.PR13.Task1;
...
public class ArrayQueueADT {
    // final - значение переменной не изменяется после инициализации
    ...
    private static void ensureCapacity(ArrayQueueADT adt, int capacity) {
        if (capacity >= adt.array.length) {
            ...
            // Если adt.tail < adt.head верно, то выполняем adt.array.length - adt.head, иначе adt.size
